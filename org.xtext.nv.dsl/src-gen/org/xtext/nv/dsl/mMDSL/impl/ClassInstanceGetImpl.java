...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Class Instance Get</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.nv.dsl.mMDSL.impl.ClassInstanceGetImpl#getNameofclassinstance <em>Nameofclassinstance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ClassInstanceGetImpl extends MinimalEObjectImpl.Container implements ClassInstanceGet
{
  /**
   ...
   * @generated
   */
  protected ClassInstanceGetImpl()
  {
    super();
  }
  ...
  {
    return MMDSLPackage.eINSTANCE.getClassInstanceGet();
  }
    ...
    if (nameofclassinstance != null && nameofclassinstance.eIsProxy())
    {
      ...
      if (nameofclassinstance != oldNameofclassinstance)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MMDSLPackage.CLASS_INSTANCE_GET__NAMEOFCLASSINSTANCE, oldNameofclassinstance, nameofclassinstance));
      }
    }
  ...
  public void setNameofclassinstance(ClassInstanceCreate newNameofclassinstance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MMDSLPackage.CLASS_INSTANCE_GET__NAMEOFCLASSINSTANCE, oldNameofclassinstance, nameofclassinstance));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MMDSLPackage.CLASS_INSTANCE_GET__NAMEOFCLASSINSTANCE:
