...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Class Instance Set</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.nv.dsl.mMDSL.impl.ClassInstanceSetImpl#getNameofclassinstance <em>Nameofclassinstance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ClassInstanceSetImpl extends MinimalEObjectImpl.Container implements ClassInstanceSet
{
  /**
   ...
   * @generated
   */
  protected ClassInstanceSetImpl()
  {
    super();
  }
  ...
  {
    return MMDSLPackage.eINSTANCE.getClassInstanceSet();
  }
    ...
    if (nameofclassinstance != null && nameofclassinstance.eIsProxy())
    {
      ...
      if (nameofclassinstance != oldNameofclassinstance)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MMDSLPackage.CLASS_INSTANCE_SET__NAMEOFCLASSINSTANCE, oldNameofclassinstance, nameofclassinstance));
      }
    }
  ...
  public void setNameofclassinstance(ClassInstanceCreate newNameofclassinstance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MMDSLPackage.CLASS_INSTANCE_SET__NAMEOFCLASSINSTANCE, oldNameofclassinstance, nameofclassinstance));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MMDSLPackage.CLASS_INSTANCE_SET__NAMEOFCLASSINSTANCE:
