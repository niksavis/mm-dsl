...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dir List</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.nv.dsl.mMDSL.impl.DirListImpl#getDirname <em>Dirname</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DirListImpl extends MinimalEObjectImpl.Container implements DirList
{
  /**
  ...
  {
    return MMDSLPackage.eINSTANCE.getDirList();
  }
  ...
  public void setDirname(String newDirname)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MMDSLPackage.DIR_LIST__DIRNAME, oldDirname, dirname));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MMDSLPackage.DIR_LIST__DIRNAME:
        return getDirname();
    }
