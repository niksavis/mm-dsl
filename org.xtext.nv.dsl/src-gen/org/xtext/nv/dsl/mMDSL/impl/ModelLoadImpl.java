...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Model Load</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.nv.dsl.mMDSL.impl.ModelLoadImpl#getModelname <em>Modelname</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ModelLoadImpl extends MinimalEObjectImpl.Container implements ModelLoad
{
  /**
  ...
  {
    return MMDSLPackage.eINSTANCE.getModelLoad();
  }
    ...
    if (modelname != null && modelname.eIsProxy())
    {
      ...
      if (modelname != oldModelname)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MMDSLPackage.MODEL_LOAD__MODELNAME, oldModelname, modelname));
      }
    }
    return modelname;
  }
  ...
  public void setModelname(ModelCreate newModelname)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MMDSLPackage.MODEL_LOAD__MODELNAME, oldModelname, modelname));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MMDSLPackage.MODEL_LOAD__MODELNAME:
