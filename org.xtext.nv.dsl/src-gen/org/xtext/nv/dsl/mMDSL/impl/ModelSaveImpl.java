...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Model Save</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.nv.dsl.mMDSL.impl.ModelSaveImpl#getModelname <em>Modelname</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ModelSaveImpl extends MinimalEObjectImpl.Container implements ModelSave
{
  /**
  ...
  {
    return MMDSLPackage.eINSTANCE.getModelSave();
  }
    ...
    if (modelname != null && modelname.eIsProxy())
    {
      ...
      if (modelname != oldModelname)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MMDSLPackage.MODEL_SAVE__MODELNAME, oldModelname, modelname));
      }
    }
    return modelname;
  }
  ...
  public void setModelname(ModelCreate newModelname)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MMDSLPackage.MODEL_SAVE__MODELNAME, oldModelname, modelname));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MMDSLPackage.MODEL_SAVE__MODELNAME:
