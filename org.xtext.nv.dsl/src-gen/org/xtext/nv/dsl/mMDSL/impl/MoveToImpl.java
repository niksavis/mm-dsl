 ...
 * <ul>
 *   <li>{@link org.xtext.nv.dsl.mMDSL.impl.MoveToImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MoveToImpl extends MinimalEObjectImpl.Container implements MoveTo
{
  ...
  {
    return MMDSLPackage.eINSTANCE.getMoveTo();
  }
  ...
  public EList<PathParametersMLT> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<PathParametersMLT>(PathParametersMLT.class, this, MMDSLPackage.MOVE_TO__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MMDSLPackage.MOVE_TO__PARAMETERS:
