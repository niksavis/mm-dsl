...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relation Instance Set</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.nv.dsl.mMDSL.impl.RelationInstanceSetImpl#getNameofrelationinstance <em>Nameofrelationinstance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RelationInstanceSetImpl extends MinimalEObjectImpl.Container implements RelationInstanceSet
{
  /**
   ...
   * @generated
   */
  protected RelationInstanceSetImpl()
  {
    super();
  }
  ...
  {
    return MMDSLPackage.eINSTANCE.getRelationInstanceSet();
  }
    ...
    if (nameofrelationinstance != null && nameofrelationinstance.eIsProxy())
    {
      ...
      if (nameofrelationinstance != oldNameofrelationinstance)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MMDSLPackage.RELATION_INSTANCE_SET__NAMEOFRELATIONINSTANCE, oldNameofrelationinstance, nameofrelationinstance));
      }
    }
  ...
  public void setNameofrelationinstance(RelationInstanceCreate newNameofrelationinstance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MMDSLPackage.RELATION_INSTANCE_SET__NAMEOFRELATIONINSTANCE, oldNameofrelationinstance, nameofrelationinstance));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MMDSLPackage.RELATION_INSTANCE_SET__NAMEOFRELATIONINSTANCE:
